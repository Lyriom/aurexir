...
const messages = {
  en: {
    ...
    product: {
      ...
      added: 'Added',
      buyNow: 'Buy now',
      buyNote: 'Secure card payment · or order by Instagram / WhatsApp.',
    ...
    cart: {
      ...
      loginToPay: 'Sign in to check out',
    ...
    checkout: {
      ...
      subtitle: 'Review your order. Shipping and payment details are completed securely on Stripe.',
      secureCheckout: 'Protected checkout',
      stepsLabel: 'Checkout progress',
      stepReview: 'Review',
      stepStripe: 'Shipping & payment',
      stepDone: 'Confirmation',
      shippingHint: 'Choose how you would like to receive your order.',
      ...
      country: 'Country',
      payment: 'Payment',
      stripeRedirect: 'You will continue to Stripe to securely enter your shipping and payment details.',
      stripeDetails: 'Address, phone and payment on Stripe',
      encrypted: 'Encrypted payment',
      receiptIncluded: 'Receipt and invoice by email',
      apiNotConfigured: 'The store API is not configured. Please contact us to complete your order.',
      loadingPayment: 'Loading secure payment…',
      stripeNotConfigured: 'Card payment isn’t available right now. Please try again later or order by WhatsApp.',
      stripeLoadError: 'We couldn’t load the payment form. Please refresh and try again.',
      securedByStripe: 'Payments secured by Stripe · your card never touches our servers',
      orderSummary: 'Order summary',
      payNow: 'Pay',
      processing: 'Processing…',
      fillFields: 'Please complete your shipping details.',
      payError: 'We couldn’t process the payment. Please check your card and try again.',
      invoiceNote: 'You’ll get a receipt and invoice (PDF) by email right after payment.',
    },
    checkoutPage: {
      checkingTitle: 'Verifying your payment…',
      checkingText: 'Please wait while we securely confirm your Stripe payment.',
      paidTitle: 'Payment received ✦',
      paidText:
        'Thank you! Your order is confirmed. We’ve emailed your receipt and invoice — you can also track it in “My orders”.',
      pendingTitle: 'Payment is processing',
      pendingText: 'Stripe is still processing your payment. Your order will update automatically when it is confirmed.',
      errorTitle: 'We could not verify this payment',
      errorText: 'Your cart was kept intact. Check “My orders” or contact us before trying to pay again.',
      orderLabel: 'Order',
      successTitle: 'Payment received ✦',
      successText:
        'Thank you! Your order is confirmed. We’ve emailed your receipt and invoice — you can also track it in “My orders”.',
      emailNote: 'We’ve emailed you the receipt and invoice (PDF). Your order arrives in 3–5 business days.',
    ...
    admin: {
      ...
      imageType: 'Only WEBP, JPEG or PNG images are allowed.',
      imageTooBig: 'Image is too large (max 5 MB).',
  ...
  es: {
    ...
    product: {
      ...
      buyNote: 'Pago seguro con tarjeta · o pide por Instagram / WhatsApp.',
    ...
    checkout: {
      ...
      subtitle: 'Revisa tu pedido. Los datos de envío y pago se completan de forma segura en Stripe.',
      secureCheckout: 'Compra protegida',
      stepsLabel: 'Progreso de la compra',
      stepReview: 'Revisión',
      stepStripe: 'Envío y pago',
      stepDone: 'Confirmación',
      shippingHint: 'Elige cómo quieres recibir tu pedido.',
      ...
      phonePlaceholder: '+1 555 123 4567',
      address1: 'Dirección',
      address2: 'Depto, piso (opcional)',
      city: 'Ciudad',
      state: 'Estado / Provincia',
      postalCode: 'Código postal',
      country: 'País',
      payment: 'Pago',
      stripeRedirect: 'Continuarás a Stripe para ingresar de forma segura tus datos de envío y pago.',
      stripeDetails: 'Dirección, teléfono y pago dentro de Stripe',
      encrypted: 'Pago cifrado',
      receiptIncluded: 'Recibo y factura por correo',
      apiNotConfigured: 'La API de la tienda no está configurada. Contáctanos para completar tu pedido.',
      loadingPayment: 'Cargando el pago seguro…',
      stripeNotConfigured: 'El pago con tarjeta no está disponible por ahora. Inténtalo más tarde o pide por WhatsApp.',
      stripeLoadError: 'No pudimos cargar el formulario de pago. Recarga e inténtalo de nuevo.',
      securedByStripe: 'Pagos protegidos por Stripe · tu tarjeta nunca pasa por nuestros servidores',
      orderSummary: 'Resumen del pedido',
      payNow: 'Pagar',
      processing: 'Procesando…',
      fillFields: 'Completa tus datos de envío.',
      payError: 'No pudimos procesar el pago. Revisa tu tarjeta e inténtalo de nuevo.',
      invoiceNote: 'Recibirás el recibo y la factura (PDF) por correo apenas se confirme el pago.',
    },
    checkoutPage: {
      checkingTitle: 'Verificando tu pago…',
      checkingText: 'Espera un momento mientras confirmamos de forma segura tu pago en Stripe.',
      paidTitle: 'Pago recibido ✦',
      paidText:
        '¡Gracias! Tu pedido está confirmado. Te enviamos el recibo y la factura por correo; también puedes seguirlo en “Mis pedidos”.',
      pendingTitle: 'Tu pago se está procesando',
      pendingText: 'Stripe todavía está procesando el pago. Tu pedido se actualizará automáticamente cuando sea confirmado.',
      errorTitle: 'No pudimos verificar este pago',
      errorText: 'Tu carrito sigue intacto. Revisa “Mis pedidos” o contáctanos antes de intentar pagar otra vez.',
      orderLabel: 'Pedido',
      successTitle: 'Pago recibido ✦',
      successText:
        '¡Gracias! Tu pedido está confirmado. Te enviamos el recibo y la factura por correo; también puedes seguirlo en “Mis pedidos”.',
      emailNote: 'Te enviamos el recibo y la factura (PDF) por correo. Tu pedido llegará en 3–5 días laborables.',
    ...
    admin: {
      ...
      uploading: 'Subiendo…',
      imageUrlHint: 'o pega una URL de imagen',
      imageType: 'Solo se permiten imágenes WEBP, JPEG o PNG.',
      imageTooBig: 'La imagen es muy grande (máx. 5 MB).',
